        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between">
            ...
            <nav>
                <ul class="flex items-center justify-between font-bold text-sm text-white uppercase no-underline">
                    ...
                    <li><a class="hover:text-gray-200 hover:underline px-4" href="#">Tags</a></li>
                    <li><a class="hover:text-gray-200 hover:underline px-4" href="#">Create wiki</a></li>
                </ul>
            </nav>
                <!-- search bar -->
           <div class="relative mt-2 ml-12 md:mt-0">
                ...
                <input type="text" class="w-full py-2 pl-10 pr-4 mr-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300" placeholder="Search">
            </div>
        </div>
    ...
    <nav class="w-full py-4 border-t border-b bg-gray-100" x-data="{ open: false }">
        ...
        <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
            <div class="w-full container mx-auto flex flex-col sm:flex-row items-center justify-center text-sm font-bold uppercase mt-0 px-6 py-2">
                ...
                <a class="flex items-center text-indigo-600 hover:bg-gray-400 hover:underline rounded py-2 px-4" href="#">
